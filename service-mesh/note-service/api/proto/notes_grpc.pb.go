...
const (
	...
	NotesService_UpdateNoteDescription_FullMethodName = "/notes.NotesService/UpdateNoteDescription"
)
...
type NotesServiceClient interface {
	...
	UpdateNoteDescription(ctx context.Context, in *UpdateNoteDescriptionRequest, opts ...grpc.CallOption) (*NoteResponse, error)
}
...
func (c *notesServiceClient) UpdateNoteDescription(ctx context.Context, in *UpdateNoteDescriptionRequest, opts ...grpc.CallOption) (*NoteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(NoteResponse)
	err := c.cc.Invoke(ctx, NotesService_UpdateNoteDescription_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NotesServiceServer interface {
	...
	UpdateNoteDescription(context.Context, *UpdateNoteDescriptionRequest) (*NoteResponse, error)
...
func (UnimplementedNotesServiceServer) UpdateNoteDescription(context.Context, *UpdateNoteDescriptionRequest) (*NoteResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateNoteDescription not implemented")
}
...
func _NotesService_UpdateNoteDescription_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateNoteDescriptionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NotesServiceServer).UpdateNoteDescription(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotesService_UpdateNoteDescription_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotesServiceServer).UpdateNoteDescription(ctx, req.(*UpdateNoteDescriptionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NotesService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateNoteDescription",
			Handler:    _NotesService_UpdateNoteDescription_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/proto/notes.proto",
}
